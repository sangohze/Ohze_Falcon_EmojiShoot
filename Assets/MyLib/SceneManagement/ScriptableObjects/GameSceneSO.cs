...
public class GameSceneSO : DescriptionBaseSO
{
	...
	public SceneReference sceneReference; //Used at runtime to load the scene from the right AssetBundle
	...
	{
		//Playable scenes
		Game, //SceneSelector tool will also load PersistentManagers and Gameplay
